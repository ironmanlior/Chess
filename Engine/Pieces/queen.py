...
class Queen(Piece, metaclass=MetaPiece):
    """
    Description:
        Queen is a Piece in Chess.
        Each player get own Queen in his/her side.
        The Queen can move both in straight line and diagonal line.
    
    Args:
        Piece (type): Queen inherits from Piece.
    ...
    def __init__(self, color: Color, id):
        super().__init__(PieceType.queen, 9, (3, 7 * color.value), color, id)
